...
file_path = 'h_3.00_run1_blobs.sphere_array.config'
...
z_traj1 = [frame[0][0] for frame in frames_data]
z_traj2 = [frame[1][0] for frame in frames_data]
...
plt.savefig('Trajectoire_z_particule1.png')
...
plt.xlabel("Time step")
plt.ylabel("z position")
plt.title("Z Trajectory of Particle 2")
plt.savefig('Trajectoire_z_particule2.png')
